<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveEvent.aspx.cs" Inherits="Milestone3.RemoveEvent" %>
...
<body>
    <form id="form1" runat="server" class="container mt-4">
        <div>
            ...
            <asp:Button ID="btnAssign" runat="server" Text="Remove" OnClick="btnAssign_Click" CssClass="btn btn-primary" />
