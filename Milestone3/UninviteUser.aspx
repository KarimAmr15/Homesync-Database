<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UninviteUser.aspx.cs" Inherits="Milestone3.UninviteUser" %>
...
<body>
    <form id="form1" runat="server" class="container mt-4">
        <div>
            ...
            <asp:Button ID="btnAssign" runat="server" Text="Uninvite" OnClick="btnAssign_Click" CssClass="btn btn-primary" />
